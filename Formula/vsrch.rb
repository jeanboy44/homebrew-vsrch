class Vsrch < Formula
  ...
  on_macos do
    url "https://github.com/jeanboy44/vsrch-release/releases/download/v0.1.1/vsrch-v0.1.1-macos-latest-20260304222931-3b1aad1.tar.gz"
    sha256 "a457e5bbef4ceca011dde95316c16f6cf06e929a20a7f60471c6d9516b828da4"
  end

  on_linux do
    url "https://github.com/jeanboy44/vsrch-release/releases/download/v0.1.1/vsrch-v0.1.1-ubuntu-latest-20260304222939-3b1aad1.tar.gz"
